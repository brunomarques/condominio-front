          ...
          <div class="lg:w-6/12 px-4 md:px-0">
            <div class="md:p-12 md:mx-6">
              <div class="text-center">
                ...
                <h4 class="text-xl font-semibold mt-1 mb-8 pb-1">Área restrita</h4>
              </div>

              <div
                  v-if="response.message"
                  :class="`bg-${response.color}-100 rounded-lg py-5 px-6 mb-4 text-base text-red-700 mb-3 shadow`" role="alert">
                {{ response.message }}
              </div>
              ...
              >
                  ...
                  <div class="flex items-center justify-between pt-1 mb-12 pb-1">
                    ...
                    <a class="text-gray-500" href="/esqueci-a-senha">Esqueceu a senha?</a>
                  </div>
              </vee-form>
            </div>
          </div>
    ...
    async login() {
      ...
      this.$axios.post('/login', payload)
        .then((response) => {
          ...
          Cookie.set('_condominioToken', token, {expires: 30})
