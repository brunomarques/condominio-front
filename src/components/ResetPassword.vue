          ...
          <div class="lg:w-6/12 px-4 md:px-0">
            <div class="md:p-12 md:mx-6">
              <div class="text-center">
                ...
                <h4 class="text-xl font-semibold mt-1 mb-8 pb-1">Alterar a senha</h4>
              </div>
              ...
              >
                <ErrorMessage class="text-red-500 text-sm mb-2" name="token" as="div" />
                <div class="mb-4">
                  <vee-field
                      type="email"
                      name="email"
                ...
                <div class="mb-4">
                  ...
                  <ErrorMessage class="text-red-500 text-sm mb-2" name="password" as="div" />
                </div>
                ...
                <div class="flex items-center justify-between pt-1 mb-12 pb-1">
                  <button
                      ...
                      "
                      :disabled="spinner.changing"
                  >
                    <div
                        v-if="spinner.changing"
...
export default {
  ...
  methods: {
    async resetPassword() {
      ...
      this.spinner.changing = true

      this.$axios.post('/reset-password', payload)
          .then(() => {
            this.response.color = "green"
            this.response.message = "Troca de senha realizada com sucesso!"
    ...
    resetForm() {
      // this.$refs.resetPasswordForm.reset() resetar o form, como?
      this.email = ''
      this.password = ''
      this.token = ''
    }
