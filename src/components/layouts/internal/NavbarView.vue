...
<script setup>
    ...
    onMounted(() => {
        useDropdown('dropdown-user-menu', 'btn-dropdown-user-menu');
        useDropdown('apps-dropdown', 'btn-apps-dropdown');
        useDropdown('notification-dropdown', 'btn-notification-dropdown');
    });*/
</script>
