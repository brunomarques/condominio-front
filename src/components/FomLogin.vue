    ...
    <div class="relative flex h-screen">
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center dark:bg-gray-600">
            <div class="max-w-md w-full p-6">
                ...
                <!-- Social Logins -->
                <div class="mt-4 flex flex-col md:flex-row gap-4 justify-center items-center text-center">
                    <div>
                        <button type="button"
                ...
                <div class="mt-4">
                    <h3 class="text-1xl font-semibold mb-6 text-gray-500 text-center dark:text-gray-300">ou por seu login e senha</h3>
                </div>
                ...
                <form action="#" method="POST" class="space-y-4" @submit.prevent="authStore.login(form)" novalidate>
                    <div>
                        ...
                        <input type="email" name="email" id="email"
                            ...
                            placeholder="email@email.com" rules="required" v-model="form.email">
                    ...
                    <div>
                        ...
                        <div v-if="authStore.errors.password" class="text-xs text-red-600 dark:text-red-400 font-semibold">
                            {{ authStore.errors.password[0] }}
                        </div>
                    </div>
                    <!--InputBasic :type="'password'" :required="true" :label="'Sua senha:'" :id="'password'" :name="'password'" :placeholder="'••••••••'" v-model="password" /-->

                    <ButtonBasic :type="'submit'" :text="'Login'" :color="'blue'" />
                </form>
...
cookies.set('test', 'vai_test', { expires: 1 });*/
